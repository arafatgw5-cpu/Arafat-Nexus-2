...
export const statsData = [
  { num: 1, text: "Years Learning Experience" },
  { num: 10, text: "Projects Completed" },
  { num: 15, text: "Technologies Learned" },
  { num: 50, text: "Problem Solving Practice" },
];
...
export const servicesData = [
  ...
  },
  {
    ...
    category: "Backend",
    level: 88,
    skillLabel: "Auth & API Integration",
    description:
