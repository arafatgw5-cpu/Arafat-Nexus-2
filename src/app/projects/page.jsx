        ...
        <div className="relative z-10">
                                  ...
                                  <TooltipTrigger asChild>
                                    ...
                                    >
                                      <Button
                                        variant="outline"
                                        size="icon"
                                        className="h-11 w-11 rounded-full border-[var(--color-primary)]/20 bg-[var(--color-primary)]/5 text-[var(--color-text)] transition-all duration-300 hover:-translate-y-1 hover:border-[var(--color-primary)] hover:bg-[var(--color-primary)]/10 hover:text-[var(--color-primary)]"
                                      >
          ...
          <div className="mt-6 flex justify-center gap-3 md:hidden">
            <Button
              ...
              size="icon"
              onClick={scrollPrev}
              className="h-11 w-11 rounded-full border border-[var(--color-primary)]/20 bg-transparent text-[var(--color-text)] hover:border-[var(--color-primary)] hover:bg-[var(--color-primary)]/10 hover:text-[var(--color-primary)]"
            >
